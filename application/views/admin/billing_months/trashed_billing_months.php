...
<th><?php echo $this->lang->line('billing_due_date'); ?></th>
            ...
            <td>
                <?php echo $billing_month->billing_due_date; ?>
                            ...
                            <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."billing_months/view_billing_month/".$billing_month->billing_month_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR."billing_months/restore/".$billing_month->billing_month_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR."billing_months/delete/".$billing_month->billing_month_id."/".$this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
