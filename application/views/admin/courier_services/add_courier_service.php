	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."courier_services/save_data", $add_form_attr);
            ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("courier_service_name"),
            ...
            <div class="form-group">
                ...
                <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
                        "style" => "",
                    ); echo form_label($this->lang->line('logo'), "logo", $label);      ?>
