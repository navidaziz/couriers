...
<div class="row">
    <div class="col-md-6">
        ...
        <label for="tracking_number" class="col-sm-5 col-form-label">Tracking Number</label>
        <div class="col-sm-7">
    ...
    <div class="form-group row">
        <label for="recipient_name" class="col-sm-5 col-form-label">Recipient Name</label>
        <div class="col-sm-7">
    ...
    <div class="form-group row">
        <label for="recipient_address" class="col-sm-12 col-form-label">Recipient Address</label>
        <div class="col-sm-12">
    ...
    <div class="form-group row">
        <label for="recipient_contact" class="col-sm-5 col-form-label">Recipient Contact</label>
        <div class="col-sm-7">
    ...
    <div class="form-group row">
        <label for="expected_delivery_date" class="col-sm-5 col-form-label">Expected Delivery Date</label>
        <div class="col-sm-7">
    ...
    <div class="form-group row">
        <label for="delivery_type" class="col-sm-5 col-form-label">Delivery Type</label>
        <div class="col-sm-7">
    ...
    <div class="form-group row">
        <label for="delivery_cost" class="col-sm-5 col-form-label">Delivery Cost</label>
        <div class="col-sm-7">
