 ...
 <h4 >Tracking Number: <strong><?php echo $delivery->tracking_number; ?></strong> <br />
...
<div>
    ...
    <div>
        ...
        <span style="margin-lef:20px;"></span>
       ...
       <form id="deliver" class="form-horizontal" enctype="multipart/form-data" method="post">
        ...
        <table style="width:100%">
            ...
            <tr>
                ...
                <button class="btn btn-success">Deliver >></button></td>
            </tr>
        </table>
        </form>
            <script>
       ...
       <form id="cancel" class="form-horizontal" enctype="multipart/form-data" method="post">
        ...
        <table style="width:100%">
            ...
            <tr>
                ...
                <button class="btn btn-danger">Cancel x</button></td>
            </tr>
        </table>
        </form>
            <script>
