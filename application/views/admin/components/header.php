...
<body>
  ...
  <header class="navbar clearfix" id="header">
    <div class="container">
      <div class="navbar-brand">
        ...
        <a href="<?php echo site_url($this->session->userdata("role_homepage_uri")); ?>"> <img src="<?php echo site_url("assets/uploads/" . $system_global_settings[0]->sytem_admin_logo); ?>" alt="<?php echo $system_global_settings[0]->system_title ?>" title="<?php echo $system_global_settings[0]->system_title ?>" class="img-responsive " style="width:100px"></a>
  ...
  <section id="page">
    ...
    <div id="main-content" <?php if ($this->router->fetch_class() == 'deliveries') { ?> class="margin-left-50" <?php } ?>>
      <div class="container">
        <div class="row">
