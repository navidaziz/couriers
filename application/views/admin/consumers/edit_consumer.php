	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."consumers/update_data/$consumer->consumer_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("consumer_id", $consumer->consumer_id); ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("consumer_cnic", $consumer->consumer_cnic),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("consumer_name", $consumer->consumer_name),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("consumer_father_name", $consumer->consumer_father_name),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $number = array(
                        ...
                        "value"         =>  set_value("consumer_contact_no", $consumer->consumer_contact_no),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $textarea = array(
                        ...
                        "rows"          =>  "",
                        "cols"          =>  "",
                        "value"         => set_value("consumer_address", $consumer->consumer_address),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("consumer_meter_no", $consumer->consumer_meter_no),
            ...
            <div class="form-group">
                <?php
                    ...
                    echo form_label("Tariff Type", $this->lang->line('tariff_id'), $label);
                ?>

                <div class="col-md-8">
                    <?php 
                        foreach($tariffs as $tariff_id => $tariff_type){
                            ...
                            $data = array(
                                ...
                                "class"       => "uniform"
                                );if("$tariff_id" == $consumer->tariff_id){
                                    $data["checked"] = TRUE;
                                }
                            echo form_radio($data)."<label for=\"$tariff_id\" style=\"margin-left:10px;\">$tariff_type</label><br />";
                            
                        }
                    ?>
                    <?php echo form_error("tariff_id", "<p class=\"text-danger\">", "</p>"); ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $date = array(
                        ...
                        "value"         =>  set_value("date_of_registration", $consumer->date_of_registration),
