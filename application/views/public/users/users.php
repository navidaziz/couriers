...
<th><?php echo $this->lang->line('role_title'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            <td>
                <?php echo $user->role_title; ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url("users/view_user/".$user->user_id."/".$this->uri->segment(4)); ?>"> View </a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
