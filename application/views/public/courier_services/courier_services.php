...
<th><?php echo $this->lang->line('logo'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url("courier_services/view_courier_service/".$courier_service->courier_service_id."/".$this->uri->segment(4)); ?>"> View </a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
