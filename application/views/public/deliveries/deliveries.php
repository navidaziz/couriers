...
<th><?php echo $this->lang->line('courier_service_name'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            <td>
                <?php echo $delivery->courier_service_name; ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url("deliveries/view_delivery/".$delivery->delivery_id."/".$this->uri->segment(4)); ?>"> View </a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
