  ...
  var handleScrollbars = function () {
    ...
    if (
      ...
      if ($("#sidebar").hasClass("sidebar-fixed") || $(window).width() <= 767) {
        ...
        if (
          android_chrome &&
          !$("#sidebar").hasClass("sidebar-fixed-responsive")
        ) {
  ...
  var handleCheckableTables = function () {
        ...
        $checkable_table_body.each(function (i, tbody) {
          $(tbody)
            ...
            .each(function (j, cb) {
              ...
              var cb_self = $(":checkbox:not(:disabled)", $(cb))
    ...
    $(".datatable.table-checkable").bind("draw", function () {
      var checkboxes_count = $(
        "tbody tr td.checkbox-column :checkbox",
        this,
      ).length;
      var checkboxes_checked_count = $(
      ...
      if (
        checkboxes_count == checkboxes_checked_count &&
        checkboxes_count != 0
      ) {
        checked = true;
      } else {
  ...
  var handleProjectSwitcher = function () {
    ...
    $("body").click(function (e) {
      ...
      if (
        ...
        $(e.target).parents().index($(".project-switcher")) == -1 &&
